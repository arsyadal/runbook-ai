...
fn render_template(session: &Session, template_name: &str, ai_summary: Option<&str>) -> String {
    ...
    // Try to load custom templates from .runbook/templates/
...
fn default_runbook_template() -> &'static str {
    "# Runbook: {{title}}\n\n\
    ## Summary\n\n\
    This runbook was generated from a Runbook session. It captures the commands, errors, changed files, notes, and verification steps from the debugging/development process.\n\n\
    ## Session Info\n\n\
    - Session ID: `{{id}}`\n\
    - Project: `{{projectName}}`\n\
    - Branch: {{branch}}\n\
...
fn default_pr_template() -> &'static str {
    ...
    {{else}}\n\
    {{title}}\n\n\
    This PR was generated from a Runbook session.\n\
    {{/if}}\n\n\
    ## Changes\n\n\
    {{files}}\n\n\
    ## Verification\n\n\
    ...
    {{/if}}\n\n\
    --- \n\
    *Generated by [Runbook](https://github.com/arsyadal/runbook-ai)*"
}
